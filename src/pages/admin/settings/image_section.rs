...
pub fn ImageSection(toast: Callback<(String, bool)>) -> Element {
            ...
            div { class: "space-y-6",
                ...
                div { class: "{ADMIN_CARD_CLASS} p-6 md:p-8 flex flex-col gap-6",
                    ...
                    div { class: "flex flex-col gap-2 max-w-xl",
                        FormLabel {
                            label: "质量系数（0.0–100.0）",
                            html_for: Some("webp-quality".to_string()),
                        }
                        input {
                            id: "webp-quality",
                            r#type: "number",
                            ...
                            oninput: move |e: Event<FormData>| {
                                ...
                                if let Ok(n) = v.parse::<f32>() {
                                    let mut d = webp_draft();
                                    d.quality = n;
                                    webp_draft.set(d);
                                    webp_just_saved.set(false);
                                }
                            },
                        }
                        p { class: "text-xs text-[var(--color-paper-secondary)]",
                            "0=最小体积，100=最佳质量。默认 85。"
                        }
                    }
                    ...
                    div { class: "flex flex-col gap-2 max-w-xl",
                        FormLabel {
                            label: "编码方法（0–6）",
                            html_for: Some("webp-method".to_string()),
                        }
                        input {
                            id: "webp-method",
                            r#type: "number",
                ...
                div { class: "{ADMIN_CARD_CLASS} p-6 md:p-8 flex flex-col gap-6",
                    ...
                    div { class: "flex flex-col gap-2 max-w-xl",
                        FormLabel {
                            label: "单边最大尺寸（像素）",
                            html_for: Some("img-dim".to_string()),
                        }
                        input {
                            id: "img-dim",
                            r#type: "number",
                            ...
                            oninput: move |e: Event<FormData>| {
                                ...
                                if let Ok(n) = v.parse::<u32>() {
                                    ...
                                    d.max_dimension = n;
                                    img_draft.set(d);
                                    img_just_saved.set(false);
                                }
                            },
                        }
                        p { class: "text-xs text-[var(--color-paper-secondary)]",
                            "上传与动态处理的宽/高上限。默认 8192，下限 512。"
                        }
                    }
                    ...
                    div { class: "flex flex-col gap-2 max-w-xl",
                        FormLabel {
                            label: "总像素上限",
                            html_for: Some("img-px".to_string()),
                        }
                        input {
                            id: "img-px",
                            r#type: "number",
                        ...
                        p { class: "text-xs text-[var(--color-paper-secondary)]",
                            "决定单图解码内存（pixels×4+1MB）。默认 50M（约 7000×7000）。"
                        }
                    }
                    ...
                    div { class: "flex flex-col gap-2 max-w-xl",
                        FormLabel {
                            label: "尺寸缓存 TTL（秒）",
                            html_for: Some("img-ttl".to_string()),
                        }
                        input {
                            id: "img-ttl",
                            r#type: "number",
                        ...
                        p { class: "text-xs text-[var(--color-paper-secondary)]",
                            "图片宽高缓存的 TTL，用于生成 aspect-ratio。默认 86400（24h）。"
                        }
                    }
                    ...
                    div { class: "flex items-center justify-between gap-4 pt-1",
                        ...
                        LoadingButton {
                            ...
                            onclick: move |_| {
                                ...
                                img_saving.set(true);
                                spawn(async move {
                                    match update_image_limit_settings(
                                            d.max_dimension,
                                            d.max_pixels,
                                            d.dimensions_cache_ttl_secs,
                                        )
                                        .await
                                    {
                                        Ok(s) => {
    ...
    {
        rsx! {
            div { class: "p-8 text-[var(--color-paper-secondary)]", "图片配置（前端渲染）" }
        }
    }
}
